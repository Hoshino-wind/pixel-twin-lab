...
| `scripts/plan_calibration.py` | Turn per-region diffs into a four-pass repair plan (layout → tokens → slice islands → rebuild), classifying each region as component-fixable or slice-worthy |
